    ...
    >
      ...
      <div className="px-4 py-3 border-b border-white/10 bg-gradient-to-r from-orange-500/10 to-transparent">
        ...
        <p className="text-xs text-white/40 mt-0.5">
          תור משימות async עם priority, retry, GPU scheduling
        </p>
      </div>
      ...
      <div className="px-3 py-2 border-b border-white/10 flex gap-1.5 overflow-x-auto">
        ...
        <button
          onClick={fetchJobs}
          className="mr-auto text-white/30 hover:text-white/60 p-0.5"
        >
          ...
          <div className="divide-y divide-white/5">
            {jobs.map((job) => {
              ...
              return (
                ...
                >
                  <div className="flex items-center gap-2">
                    <div className={cn("flex-shrink-0", cfg.color)}>
                      {cfg.icon}
                    </div>
                      ...
                      <div className="flex items-center gap-2 mt-0.5">
                        ...
                        {job.attempts > 0 && (
                          <span className="text-[10px] text-orange-400/60">
                            {job.attempts}/{job.maxAttempts} ניסיון
                          </span>
                        )}
                      </div>
                    </div>
                  ...
                  {job.error && (
                    <div className="mt-1.5 text-[10px] text-red-400/80 bg-red-500/10 rounded px-2 py-1">
                      {job.error}
                    </div>
                  )}
