...
const MODES = [
  {
    ...
    description:
      "תאר את הרעיון שלך בשפה פשוטה. ה-AI מטפל בכל ההחלטות הטכניות ובונה את המוצר מיידית.",
    features: [
      "שפה עסקית פשוטה",
      "ללא מונחים טכניים",
      "תוצאות מיידיות",
  ...
  },
  {
    ...
    description:
      "ראה את הקוד מאחורי המוצר עם הסברים ברורים. שנה דרך שיחה או ערוך ישירות — ללא תכנות עמוק.",
    features: [
      "קוד גלוי",
      "הסברי ארכיטקטורה",
      '"למה בנית ככה?"',
  ...
  },
  {
    ...
    description:
      "קוד ברמת פרודקשן עם עומק טכני — הערות ביצועים, ניתוח אבטחה, החלטות stack.",
    features: [
      "פרטים טכניים מלאים",
  ...
  },
  {
    ...
    description:
      "בונה דברים מגניבים לעצמך — משחקים, כלים אישיים, ניסויים. ה-AI הוא חבר, לא יועץ עסקי.",
    features: [
      "שתי שאלות ואז build מיידי",
      "רעיונות יצירתיים מפתיעים",
      "Three.js, Canvas, Web Audio",
      "ללא שאלות עסקיות",
    ],
    color: "purple",
              ...
              >
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p
                      className="text-xs text-slate-500 leading-relaxed mb-2"
                      style={{ fontFamily: HE }}
                    >
                      {mode.description}
                    </p>
        ...
        <div className="px-5 py-3 border-t border-white/[0.06] bg-[#0a0a0f]">
          ...
          >
            ...
            <span className="text-indigo-400/80">
              Grow With Me — הפלטפורמה גדלה עם הכישורים שלך.
            </span>
          </p>
        </div>
      </motion.div>
