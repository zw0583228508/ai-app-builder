        ...
        try {
          ...
          if (msg.type === "presence") {
            ...
            setState((s) => ({
              ...s,
              cursors: [
                ...s.cursors.filter((c) => c.clientId !== cursor.clientId),
                cursor,
              ],
            }));
            ...
            setState((s) => ({
              ...s,
              cursors: s.cursors.filter((c) => c.clientId !== msg.clientId),
            }));
          } else if (msg.type === "project-updated") {
            window.dispatchEvent(
              new CustomEvent("collab-project-updated", {
                detail: { projectId: msg.projectId },
              }),
            );
          } else if (msg.type === "project-event") {
            window.dispatchEvent(
              new CustomEvent("collab-project-event", { detail: msg }),
            );
          }
        } catch {
          /* ignore */
