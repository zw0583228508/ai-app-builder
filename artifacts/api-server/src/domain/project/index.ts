...
export type ProjectType = "website" | "webapp" | "landing" | "portfolio" | "mobile" | "saas";
export type ProjectStack = "html" | "react" | "nextjs" | "vue" | "svelte" | "django";
 ...
 * Business rules
 */
export function isProjectOwner(project: Pick<ProjectEntity, "userId">, userId: string | undefined): boolean {
  if (!project.userId) return true; // Anonymous project
  if (!userId) return false;
  return project.userId === userId;
}

export function canShareProject(project: Pick<ProjectEntity, "previewHtml" | "stack">): boolean {
