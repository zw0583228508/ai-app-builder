...
export function inferSkillLevel(userMode: string): "beginner" | "intermediate" | "expert" {
  switch (userMode) {
    case "developer": return "expert";
    case "builder": return "intermediate";
    case "maker": return "intermediate";
    case "entrepreneur": return "beginner";
